...
Bu repository, FinTechBankX DDD/EDA dönüşümünde **svc-obs-sre** servis yetkinliğinin kaynak kodunu, kontratlarını ve operasyonel guardrail'lerini içerir.
...
| Squad | Observability and SRE Squad |
| Repo Kümesi (Capability) | platform |
| Service ID | svc-obs-sre |
| Bounded Context | observability_sre |
| Wave | 0 |
...
## Kapsam
### In Scope
- observability_sre bağlamına ait uygulama kodu, testler ve otomasyon.
