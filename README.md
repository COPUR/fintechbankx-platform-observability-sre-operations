...
- **Squad:** Observability & SRE Squad
- **Repo Kümesi:** `platform-observability`
- **Bounded Context:** `platform`
- **Ana Capability:** Tracing, metrics, logs and SRE guardrails
- **Dönüşüm Wave:** 0
...
- `Tracing, metrics, logs and SRE guardrails` kapsamında kod, sözleşme, test, runbook ve release artefaktları.
